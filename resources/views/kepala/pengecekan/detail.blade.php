...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* CONTENT */
        .content { flex: 1; padding: 0 16px 100px; margin-top: -24px; }
        ...
        .card-title h3 { color: #1a8fb3; font-size: 17px; font-weight: 700; }
        .card-title p { color: #1a8fb3; font-size: 13px; margin-top: 2px; }
        ...
        .info-table td:nth-child(2) { color: #666; width: 5%; }
        ...
        .doc-icon.blue { background: #4e63e8; }
        .doc-icon.pink { background: #e84e8a; }
        .doc-icon.orange { background: #f5a623; }
        .doc-name { font-size: 14px; font-weight: 600; color: #333; }
        ...
        .radio-opt .lbl-lengkap { color: #2ecc71; font-weight: 600; }
        .radio-opt .lbl-tidak { color: #e74c3c; font-weight: 600; }

        /* CATATAN */
        .field-label { color: #1a8fb3; font-size: 13px; font-weight: 600; margin-bottom: 7px; }
        .field-input {
            width: 100%; background: #eaf6fb; border: none;
            border-radius: 14px; padding: 12px 16px;
            font-size: 14px; color: #333; outline: none;
            font-family: inherit; resize: none; height: 90px;
        }
        ...
        .btn-setuju {
            flex: 1; background: #2ecc71; color: #fff;
            border: none; border-radius: 50px; padding: 15px;
            font-size: 15px; font-weight: 700; cursor: pointer;
            font-family: inherit; transition: background 0.2s;
        }
        ...
        .btn-kembali {
            width: 100%; background: #fff; color: #1a8fb3;
        ...
        .btn-kembali:hover { background: #eaf6fb; }
        ...
        .status-banner.disetujui { background: #d4edda; color: #155724; }
        .status-banner.ditolak { background: #fdecea; color: #c0392b; }
    ...
    <div class="content">
        ...
        <form method="POST" action="{{ route('kepala.pengecekan.store', $pengajuan->id) }}">
            ...
            <div style="margin-top: 8px;">
                ...
                <textarea name="catatan_pengecekan" class="field-input"
                    placeholder="Tambahkan catatan jika ada...">{{ old('catatan_pengecekan', $pengecekan->catatan_pengecekan ?? '') }}</textarea>
            </div>
