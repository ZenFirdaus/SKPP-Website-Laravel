...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .card-nama { color: rgba(255,255,255,0.92); font-size: 13px; margin-bottom: 4px; }
        ...
        .badge-menunggu { background: #ff6b9d; color: #fff; }
        .badge-disetujui { background: #2ecc71; color: #fff; }
